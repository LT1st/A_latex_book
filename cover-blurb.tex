...
\special{pdf:docinfo <<
/Title (This boy is from the Steppe.)   % set your title here
/Author (Lu Tao)       % set author name
/Subject (That's me)          % set subject
/Keywords (a self introduction) % set keywords
/Trapped (False)
/GTS_PDFXVersion (PDF/X-3:2002)
% must have a trim box, but I think Blurb ignores the values
/TrimBox [0.00000 9.00000 684.36000 585.00000] >>
...
\centering
\includegraphics[width=4in]{a_dog_seeing_remote.jpg}
